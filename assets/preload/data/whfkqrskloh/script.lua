...
local xx = 590; -- Code to change the position of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 280; -- Code to change the position of the camera up or down for the enemy Less = Down (They can be negative numbers), More = Up
local xx2 = 1320; -- Same code as above, but for boyfriend left, right
local yy2 = 280; -- Same code as above, but for boyfriend up, down
